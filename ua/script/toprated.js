...
document.addEventListener('DOMContentLoaded', () => {
	...
	fetch('https://api.themoviedb.org/3/movie/top_rated?api_key=20ea6a54518a25a3b110a6646d33a414&language=uk&page=1&region=UA')
		.then((value) => {
			if (value.status !== 200) {
				return Promise.reject(value);
			}
		...
		.then((output) => {
			let inner = '<p class="list__title">Найвища оцінка</p>';
